    ...
    <div style={{ background: 'var(--brand-bg)', minHeight: '100vh', padding: '20px 16px', paddingBottom: 100 }}>
      ...
      <div style={card}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          ...
          <button onClick={() => router.push('/schedule')} style={{ fontSize: 11, fontWeight: 700, color: 'var(--brand-primary)', background: 'rgba(124,156,245,.1)', border: 'none', borderRadius: 8, padding: '4px 10px', cursor: 'pointer' }}>Full schedule Ã¢ÂÂ</button>
        </div>
        ...
        {todaySessions.length > 3 && <div style={{ textAlign: 'center', paddingTop: 6, color: '#c5ccdb', fontSize: 10, fontWeight: 600 }}>Ã¢ÂÂ scroll for full day</div>}
      </div>
        ...
        <div style={card}>
          ...
          <div onClick={() => router.push('/payments')} style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 11, color: 'var(--brand-text-secondary)' }}>${paymentTotal} ÃÂ· review drafts to send</div>
            </div>
      ...
      <div style={card}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          ...
          <button onClick={() => router.push('/clients')} style={{ fontSize: 11, fontWeight: 700, color: 'var(--brand-primary)', background: 'rgba(124,156,245,.1)', border: 'none', borderRadius: 8, padding: '4px 10px', cursor: 'pointer' }}>All clients Ã¢ÂÂ</button>
        </div>
      ...
      {feedbackOpen && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(20,30,55,.5)', zIndex: 400, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
          <div style={{ background: 'var(--brand-card)', borderRadius: 24, padding: 24, width: '100%', maxWidth: 400 }}>
            ...
            {feedbackSent ? (
              <div style={{ textAlign: 'center', padding: '20px 0', color: '#5ec9a3', fontWeight: 700, fontSize: 16 }}>Ã¢ÂÂ Thanks! Sent.</div>
            ) : (
              <>
      ...
      {/* Floating AI + Feedback Ã¢ÂÂ trainer only, draggable pair */}
