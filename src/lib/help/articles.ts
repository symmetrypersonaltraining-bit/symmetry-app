...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    intro: "Stay connected with your coach's group and cheer each other on.",
    steps: [
      "Open the group thread from Messages to see posts from your coach and the other people they train.",
      "It is your coach's group. Another coach's clients are not in it and cannot see it.",
  ...
  },
  {
    ...
    audience: "all",
    icon: "trophy",
    keywords: ["challenge", "leaderboard", "board", "weekly", "compete", "streak", "coach bot", "group"],
    intro: "A new one every Monday, scored through Sunday, in your coach's group.",
    steps: [
      "A challenge starts automatically every Monday and runs to Sunday. It rotates through a few kinds — most days trained, log every day, and so on.",
      "Tap Join in the group thread to be named on the board. You are counted either way; joining is how you say you want your name on it.",
      "There is an anonymous group total too, so the board is worth looking at from day one.",
      "Sunday evening it scores itself and your coach's group gets the result.",
      "Trainers: you can start one by hand or end the running one early from the group thread. It only ever touches your own group, and you are never ranked on your own board.",
    ],
  },
  {
    id: "notifications",
  ...
  // code change on 11 Aug 2026.
  {
    ...
    steps: [
      ...
      "Inside one instance, each trainer has their own of everything too: your own roster, your own group chat, your own weekly challenge and board, and your own Coach Bot and birthday bot. Another trainer's clients are never on your board or in your room.",
