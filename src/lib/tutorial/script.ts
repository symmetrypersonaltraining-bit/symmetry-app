    ...
    steps: [
      ...
      },
      {
        ...
        body: [
          ...
          "Underneath the line, their app now shows the coach's read: two or three sentences on how their training actually went, from the same Saturday pass. It was being written every week and shown to nobody until 5 September. Like the focus line, it disappears rather than going stale.",
          "It only writes about what it can see. A client who has never logged food is not told about food, except one light invitation every fourth week; a client who logged and stopped gets pushed to start again. Every third week it may add one general line — sleep, water, rest — and why it matters. The rest is their own numbers.",
        ...
        narration:
          "Each client carries one focus line for the week, written late on Saturday from their real numbers. Underneath it their app now shows the coach's read — two or three sentences on how the training actually went. Both publish straight to them; there is nothing to approve, and writing one yourself leaves the automatic one alone that week. It only writes about what it can see: a client who has never logged food is not told about food, and one who logged and stopped gets pushed. The card on Home tells you whether it worked, with the lines one tap away. If it fails you get an email, and a client sees no focus rather than last week's.",
        route: "/home",
        routeLabel: "Open Home",
        manual: [
    ...
    steps: [
      ...
      },
      {
        ...
        body: [
          ...
          "The first step also asks height and sex. They go straight onto the client's record — the same place onboarding and their profile write them — because the meal-plan consult needs them, with weight and age, to work out a daily expenditure honestly, and it is not allowed to guess them.",
        ],
        narration:
          "The third step is an overhead squat assessment. You tick what you actually see. Feet turning out, forward lean, knees caving, arms falling forward, a lateral shift, balance. The step before it now ends with what to work around. Chips for the ones that recur, then a box for anything those cannot hold, and one for trainer notes. Their coach reads all of it. The first step also asks height and sex, which go straight onto the client's record. And for somebody already on your roster, open their session: if they have no assessment the app stops you first and offers to do it, with their details filled in.",
        audioUrl: null,
      },
      {
        id: "clients-invite",
