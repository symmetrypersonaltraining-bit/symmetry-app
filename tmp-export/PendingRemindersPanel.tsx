    ...
    <div className="rounded-2xl overflow-hidden mb-6"
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: "var(--brand-text-secondary)" }}>
              {reminders.length} due Â· ${totalDue.toLocaleString()} total
            </p>
          </div>
        </div>
            ...
            <div key={r.id}
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  <span className="text-xs" style={{ color: "var(--brand-text-secondary)" }}>Â· {fmtDate(r.dueDate)}</span>
                  {r.smsSentAt && (
      ...
      {reminders.length > 4 && (
        <button onClick={() => setExpanded(e => !e)}
          ...
          {expanded ? "Show less â" : `Show ${reminders.length - 4} more â`}
        </button>
      )}
    </div>
  );
